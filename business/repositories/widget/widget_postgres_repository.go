...
// CreatePg a widget
func CreatePg(w widget.Widget) (int, error) {
...
// ReadPg widgets
func ReadPg(id int) ([]widget.Widget, error) {
	db, err := database.Connect()
	if err != nil {
...
// UpdatePg widget
func UpdatePg(w widget.Widget) (int, error) {
	db, err := database.Connect()
	if err != nil {
		return 0, err
	}
...
// DeletePg widget
func DeletePg(w widget.Widget) (int, error) {
	db, err := database.Connect()
	if err != nil {
		return 0, err
	}
